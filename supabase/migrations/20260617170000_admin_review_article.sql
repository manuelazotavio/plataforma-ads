...
revoke all on function public.admin_review_article(uuid, text, text) from public;
grant execute on function public.admin_review_article(uuid, text, text) to authenticated;
